...
public class AddEventController implements Initializable {
    ...
    private HBox header;
    @FXML
    private JFXTextField IndicatorTextField;
    ...
    @FXML
    private JFXComboBox<String> DoctorComboBox;
    ...
    void save(MouseEvent event) {
        ...
        if (subject.getValue() == null || termSelect.getSelectionModel().isEmpty()
             || DoctorComboBox.getSelectionModel().isEmpty()   || date.getValue() == null
                || IndicatorTextField.getText().isEmpty()) {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        subject.setValue(LocalTime.now());
        ...
        try {
            ...
            DoctorComboBox.setItems(termss);
    ...
    if (indicatvalue.equals("Appointment")){IndicatorTextField.setPromptText("Enter Booking information");}
    else IndicatorTextField.setPromptText("Task");
    });
